...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(process.env.EMAILJS_SERVICE_ID,
                 process.env.EMAILJS_TEMPLATE_ID,
                 {
                  from_naem: form.name,
                  to_name: 'Kalab',
                  from_email: form.email,
                  to_email: 'kalab27solomon@gmail.com',
      ...
      <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        <form ref={fromRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <lable className="flex flex-col">
            ...
            <textarea row="7" name="message" value={form.message} onChange={handleChange} placeholder="Enter your message"
                   className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none"/>
          </lable>
